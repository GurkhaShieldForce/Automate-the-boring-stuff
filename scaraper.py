...
const BROWSER_WS = "AUTH STRING"; #AUTH STRING

const search_text = "New York";
const check_in = "2024-07-19";
const check_out = "2024-07-20";
...
async function close_popup(page) {
  try {
    const close_btn = await page.waitForSelector('[aria-label="Dismiss sign-in info."]', { timeout: 60000, visible: true });
